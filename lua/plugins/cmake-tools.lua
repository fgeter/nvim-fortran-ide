...
local function activate()
  ...
  ---------------------------------------------------------------------------
  -- Helper: find a real editor window
  ---------------------------------------------------------------------------
  -- Returns the first window that is a normal file buffer, skipping
  -- neo-tree, terminal windows, and all dap-ui panels. Used to restore
  -- focus after cmake output windows open and close.
